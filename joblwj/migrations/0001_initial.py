# Generated by Django 2.2.6 on 2020-03-25 21:22
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('scriptcontent', models.CharField(blank=True, max_length=50, null=True, verbose_name='脚本内容')),
                ...
                ('scriptname', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='joblwj.SelectScript', verbose_name='脚本名称')),
            ],
            options={
                'ordering': ['-id'],
            },
